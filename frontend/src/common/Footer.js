...
const Footer = () => {
  ...
  return (
    <footer className="text-white body-font bg-gray-400 mt-20">
      <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <div className="font-bold text-2xl cursor-pointer flex items-center font-[Poppins] text-black">
            <h3 style={{ fontStyle: "italic", fontWeight: "bold"}}>LayoutIndex</h3>
            <span className="text-xl pl-2">Location Detailer</span>
          </div>
          <p className="mt-2 text-sm text-black">
            Find your locations, when you want…!
          </p>
        </div>
      ...
      <div className=" bg-gray-600">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-gray-300 text-sm text-center sm:text-left">
            Copyright © {date.getFullYear()} Location Detailer —
            <a
              href="#"
